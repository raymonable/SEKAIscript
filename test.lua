...
--local builtins = require(script:WaitForChild('builtins'))
...
local builtins = {
	...
	["settings"] = true;["spawn"] = true;["tick"] = true;["time"] = true;["type"] = true;
...
Interpret([[
# set var 000001 and var 000010 to string "a"
Z000001A 00000097
Z0000021 Z0000010
# set var 100000 to current jump point
Z1000001 FC8353F8
# print var 000001
6D0D5876 Z0000020
# append
